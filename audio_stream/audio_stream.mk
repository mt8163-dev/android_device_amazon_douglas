...
LIBAUDIOSTREAM_JNI := out/target/product/douglas/system/lib64/libaudiostream_jni.so

AUDIO_STREAM_AMAZON_SYMLINK := $(TARGET_OUT_SYSTEM)/lib64/libaudiostream_jni.AMAZON.so
